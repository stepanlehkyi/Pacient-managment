...
int main()
{
   ...
   // спочатку ім'я потім прізвище, спочатку скарги, потім діагноз
    Pacient a;
    a.Init("Степан","Легкий","Йосифович",0,"26.06.1995","+380975410329","м.Івано-Франківськ, вул.Вовчинецька 30, 12","Гострий пульпіт 45 ","Нестерпний біль в нижньому правому зубі ","Алергологічний анамнез не обтяжений") ;
